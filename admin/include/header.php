...
<title>Chebafam kennels | admin Dashboard</title>
...
<img src="assets/img/bootstrapr-logo.png" alt="bootraper logo" class="app-logo">
</div>
...
<li>
<a href="#uielementsmenu" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle no-caret-down"><i class="fas fa-tools"></i>Services</a>
<ul class="collapse list-unstyled" id="uielementsmenu">
<li>
<a href="add_service.php"><i class="fas fa-angle-right"></i> Add service</a>
</li>
<li>
<a href="manage_service.php"><i class="fas fa-angle-right"></i> Manage service</a>
</li>
...
<li>
<a href="contact.php"><i class="fas fa-comments"></i>Contacts</a> 
</li>
<li><a href='testimonies.php'><i class="fas fa-smile"></i>Testimonies</a></li>
<li><a href="quote.php"><i class="fas fa-thumbs-up"></i>Quotes</a></li>
<li><a href="top_dogs.php"><i class="fas fa-dog"></i>Top dogs</a></li>
<li>
<a href="settings.php"><i class="fas fa-cog"></i>Application Settings</a>
</li>

<!-- <li>
<a href="fo"><i class="fas fa-file-alt"></i> Forms</a>
</li>
<li>
